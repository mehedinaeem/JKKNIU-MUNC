                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link to="/" className="flex items-center space-x-3 group">
                        ...
                        <div className="hidden sm:block">
                            <span className={`font-heading font-bold text-xl transition-colors duration-300 ${isScrolled ? 'text-primary-700' : 'text-white'
                                }`}>
                                JKKNIU MUN
                            </span>
                            <span className={`block text-xs font-medium transition-colors duration-300 ${isScrolled ? 'text-primary-500' : 'text-white/80'
                                }`}>
                        ...
                        {navLinks.map((link) => (
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    ...
                                    } ${isScrolled ? 'after:bg-primary-600' : 'after:bg-accent-400'}`
                                }
                            >
                                {link.name}
                            </NavLink>
